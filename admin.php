...
$php =array('admin/','administrator/','admin1/','admin2/','admin3/','admin4/','admin5/','usuarios/','usuario/','moderator/','webadmin/','adminarea/','bb-admin/','adminLogin/','admin_area/','panel-administracion/','instadmin/',
...
);$cgi = array('admin/','administrator/','admin1/','admin2/','admin3/','admin4/','admin5/','usuarios/','usuario/','administrator/','moderator/','webadmin/','adminarea/','bb-admin/','adminLogin/','admin_area/','panel-administracion/','instadmin/',
...
);$js = array('admin/','administrator/','admin1/','admin2/','admin3/','admin4/','admin5/','usuarios/','usuario/','administrator/','moderator/','webadmin/','adminarea/','bb-admin/','adminLogin/','admin_area/','panel-administracion/','instadmin/',
...
);$cfm = array('admin/','administrator/','admin1/','admin2/','admin3/','admin4/','admin5/','usuarios/','usuario/','administrator/','moderator/','webadmin/','adminarea/','bb-admin/','adminLogin/','admin_area/','panel-administracion/','instadmin/',
...
$brf =array('admin/','administrator/','admin1/','admin2/','admin3/','admin4/','admin5/','usuarios/','usuario/','administrator/','moderator/','webadmin/','adminarea/','bb-admin/','adminLogin/','admin_area/','panel-administracion/','instadmin/',
...
$asp =array('admin/','administrator/','admin1/','admin2/','admin3/','admin4/','admin5/','moderator/','webadmin/','adminarea/','bb-admin/','adminLogin/','admin_area/','panel-administracion/','instadmin/',
...
function crot($string, $fontColor=NULL) {
		switch ($fontColor) {
	...
	| (_| | (_| | | | | | | | | | |  _| | | | | (_| |___) | |   
	 \__,_|\__,_|_| |_| |_|_|_| |_|_| |_|_| |_|\__,_|____/|_| 

		# coded by zeyad besiso [shad0w]  @ZEY4D_
	-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-
	| Greetings for all Palestinians c0ders    V        |
	| and all GNU Generation                 (o o)      |
	|				        (  V  )     |
	|.........................................m.m.......|
        | Usage  : php find.php [target] [type] [output]    |
 	| target : domin / url			            |
	| type   : -php -js -asp -cgi -cfm  -brf  	    |
	| output : output will be saved to (optional)       |
	-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-	"  ;  
     
		echo  crot($msg,'yellow');
	}
?>
